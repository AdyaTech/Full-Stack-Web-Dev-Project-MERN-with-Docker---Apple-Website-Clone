require = function() {
    ...
    30: [function(require, module, exports) {
        ...
        var _acConsole = require("@marcom/ac-console"),
            ...
            addEventListeners = function() {
                var e, t;
                window.ac_target = window.ac_target || {}, document.addEventListener("at-request-succeeded", function(a) {
                    (0, _acConsole.log)("ac-target : at-request-succeeded");
                    var i = "no tests found";
                    if (a && a.detail && a.detail.responseTokens && (t = (0, _util.removeDuplicateActivities)(a.detail.responseTokens))) {
                        e = (0, _util.getActivitiesIds)(t);
                        var s = (0, _util.buildActNameExpNameString)(t);
                        s && (i = s)
                    }
                    window.ac_target && (window.ac_target.data = i)
                }), document.addEventListener(_settings.defaultSettings.constants.atSuccessEventName, function() {
                    (0, _acConsole.log)("ac-target : at-rendering succeeded"), t && e.forEach(function(e) {
                        var a = (0, _util.convertActivityId)(e) || e,
                            i = (0, _util.getExperienceId)(t, e),
                            s = (0, _util.getActivityEndDate)(a);
                        (0, _storage.set)(a, i, s)
                    })
                }), document.addEventListener("at-request-failed", function(e) {
                    (0, _acConsole.log)("ac-target : at-request-failed");
    ...
    31: [function(require, module, exports) {
        ...
        function initializeTarget(e) {
            !window || window.adobe && window.adobe.target || (window.adobe = window.adobe || {}, window.adobe.target = at(), window.adobe.target.init(window, document, e))
        }
    }, {
        "./vendor/at": 35
    }],
    32: [function(require, module, exports) {
        ...
        var _acConsole = require("@marcom/ac-console"),
            ...
            astexDataProvider = {
                ...
                version: "1.0.0",
                provider: function(e) {
                    (0, _acConsole.log)("ac-target : dataProvider"), (0, _storage.get)().then(function(t) {
                        e(null, {
                            as_tex: t || ""
                        })
                    })
        ...
        var defaultSettings = {
            constants: {
                ...
                storageName: "as_tex",
                atSuccessEventName: document.querySelector('meta[name="csmvt-enabled"]') ? "mvt-body-attribute-set" : "at-content-rendering-succeeded"
            },
            options: {
                autoInitialize: !0
            },
            config: {
                ...
                pageLoadEnabled: !document.querySelector('meta[name="csmvt-enabled"]'),
                viewsEnabled: !document.querySelector('meta[name="csmvt-enabled"]'),
    ...
    33: [function(require, module, exports) {
        ...
        var _regenerator = _interopRequireDefault(require("@babel/runtime/regenerator")),
                ...
                var e = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function e() {
                    ...
                    return _regenerator.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if ((0, _acConsole.log)("ac-target : fetchCookie"), e.prev = 1, (t = (0, _acTarget.getInstanceSettings)()) && t.constants && t.constants.origin && t.constants.asTexServiceEndpoint) {
                                    e.next = 5;
                                    break
                                }
                                return e.abrupt("return");
                            case 5:
                                return n = "".concat((0, _acTarget.getInstanceSettings)().constants.origin).concat((0, _acTarget.getInstanceSettings)().constants.asTexServiceEndpoint), e.next = 8, fetch(n, {});
                            case 8:
                                if ((r = e.sent).ok) {
                                    e.next = 11;
                                    break
                            ...
                            case 13:
                                return a = e.sent, e.abrupt("return", parseFetchResponse(a));
                            case 17:
                                e.prev = 17, e.t0 = e.catch(1), (0, _acConsole.log)("ac-target : fetch error while getting as_tex", e.t0);
                            case 20:
            ...
            setCookie = function() {
                var e = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function e(t, n, r) {
                    var a, o, c, s, i, u;
                    return _regenerator.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if ((0, _acConsole.log)("ac-target : setCookie"), (a = (0, _acTarget.getInstanceSettings)()) && a.constants && a.constants.origin && a.constants.asTexServiceEndpoint) {
                                    e.next = 4;
                                    break
                                }
                                return e.abrupt("return");
                            case 4:
                                ...
                                }).join("&"), s = "".concat((0, _acTarget.getInstanceSettings)().constants.origin).concat((0, _acTarget.getInstanceSettings)().constants.asTexServiceEndpoint, "?").concat(c), e.prev = 7, e.next = 10, fetch(s);
                            case 10:
                                return i = e.sent, e.next = 13, i.json();
                            case 13:
                                return u = e.sent, e.abrupt("return", parseFetchResponse(u));
                            case 17:
            ...
            getCookieInLocalStorage = function() {
                (0, _acConsole.log)("ac-target : getCookieInLocalStorage");
                var e = (0, _acTarget.getInstanceSettings)();
                if (e && e.constants && e.constants.storageName) return window.localStorage.getItem((0, _acTarget.getInstanceSettings)().constants.storageName)
            },
            setCookieInLocalStorage = function(e) {
                (0, _acConsole.log)("ac-target : setCookieInLocalStorage");
                var t = (0, _acTarget.getInstanceSettings)();
                if (t && t.constants && t.constants.storageName) {
                    var n = (0, _acTarget.getInstanceSettings)().constants.storageName;
            ...
            set = function() {
                var e = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function e(t, n, r) {
                    return _regenerator.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                !1 === isRequesting ? (isRequesting = !0, setCookie(t, n, r).then(function(e) {
                                    if (isRequesting = !1, astexQueue.length) {
    ...
    34: [function(require, module, exports) {
        ...
        var isNode = function(e) {
            return "object" === ("undefined" == typeof Node ? "undefined" : (0, _typeof2.default)(Node)) ? e instanceof Node : e && "object" === (0, _typeof2.default)(e) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
        };
            ...
            (function() {
                ...
                function at() {
                    ...
                    if (!r || o && !1 === o.enabled) return t.adobe = t.adobe || {}, t.adobe.target = {
                        ...
                        init: it
                    }, t.mboxCreate = it, t.mboxDefine = it, t.mboxUpdate = it, "console" in t && "warn" in t.console && t.console.warn("AT: Adobe Target content delivery is disabled. Update your DOCTYPE to support Standards mode."), t.adobe.target;
                    var i = window,
                        u = document,
                    ...
                    var f = function() {
                        ...
                        for (var n, r, o = function(t) {
                            ...
                            for (var u in n = Object(arguments[i])) a.call(n, u) && (o[u] = n[u]);
                            if (c) {
                                r = c(n);
                                for (var f = 0; f < r.length; f++) s.call(n, r[f]) && (o[r[f]] = n[r[f]])
                            }
                        }
                        return o
                    };
                    ...
                    function g(t) {
                        return (g = "function" == typeof Symbol && "symbol" == (0, _typeof2.default)(Symbol.iterator) ? function(t) {
                    ...
                    function H(t) {
                        if (null == t) return !0;
                        if (M(t) && (p(t) || j(t) || w(t.splice))) return !t.length;
                        for (var e in t)
                    ...
                    function dt() {
                        ...
                        return "xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g, function(e) {
                            var n = (t + (16, 0 + Math.floor(17 * Math.random()))) % 16 | 0;
                    ...
                    function _r(t, e, n) {
                        ...
                        t.location.protocol === Sr || (r = function(t) {
                                ...
                                var e, n = null == (e = lt(".", t)) ? e : ft.call(e),
                                    r = n.length;
                                return r >= 3 && kr.test(n[1]) ? n[2] + "." + n[1] + "." + n[0] : 1 === r ? n[0] : n[1] + "." + n[0]
                            }(t.location.hostname)), n[An] = r, n[sn] = function(t) {
                                var e = t.compatMode;
                            ...
                            function(t, e) {
                                t[sn] && (v(e[hn]) || (t[Jn] = e[hn]), q(function(n) {
                                    v(e[n]) || (t[n] = e[n])
                                }, Or))
                            }(n, t[Hn] || {})
                    }
                    ...
                    var jr = function(t, e, n, r) {
                            ...
                            for (var a = 0; a < c; ++a) {
                                var s, f, l, d, v = t[a].replace(i, "%20"),
                                    p = v.indexOf(n);
                                p >= 0 ? (s = v.substr(0, p), f = v.substr(p + 1)) : (s = v, f = ""), l = decodeURIComponent(s), d = decodeURIComponent(f), Rr(o, l) ? Array.isArray(o[l]) ? o[l].push(d) : o[l] = [o[l], d] : o[l] = d
                            }
                            return o
                        },
                        Dr = function(t) {
                        ...
                        Lr = function(t, e, n, r) {
                            return e = e || "&", n = n || "=", null === t && (t = void 0), "object" == (0, _typeof2.default)(t) ? Object.keys(t).map(function(r) {
                        ...
                        Mr = Ar(function(t, e) {
                            e.decode = e.parse = jr, e.encode = e.stringify = Lr
                        }),
                        Vr = (Mr.decode, Mr.parse, Mr.encode, Mr.stringify, function(t, e) {
                            e = e || {};
                            for (var n = {
                        ...
                        Ur = function(t) {
                            return "string" == typeof t && (t = t.trim().replace(/^[?#&]/, "")), Mr.parse(t)
                        },
                        Fr = function(t) {
                    ...
                    function Gr(t) {
                        ...
                        Hr.href = t;
                        var e = Vr(Hr.href);
                        return e.queryKey = Br(e.query), $r[t] = e, $r[t]
                    }
                    var Kr = Pr.get,
                        Xr = Pr.set,
                        Yr = Pr.remove,
                    ...
                    function mo(t, e, n, r) {
                        e === Un && t[Fn].push(n), r && e !== Un && t[Fn][e].push(f({
                            timestamp: ut()
                        }, n))
                    }
                    ...
                    var yo = Ar(function(t) {
                            ! function(e) {
                                ...
                                function u(t, e) {
                                    try {
                                        ...
                                        if (e && ("object" == (0, _typeof2.default)(e) || "function" == typeof e)) {
                                            var n = e.then;
                                ...
                                o.prototype.catch = function(t) {
                                    ...
                                    return t && "object" == (0, _typeof2.default)(t) && t.constructor === o ? t : new o(function(e) {
                                        e(t)
                                    })
                                }, o.reject = function(t) {
                        ...
                        xo = function(t) {
                            var e = function() {
                                ...
                                function z(t, r, o) {
                                    for (n in r) o && (M(r[n]) || q(r[n])) ? (M(r[n]) && !M(t[n]) && (t[n] = {}), q(r[n]) && !q(t[n]) && (t[n] = []), z(t[n], r[n], o)) : r[n] !== e && (t[n] = r[n])
                                }
                                ...
                                return N.matches = function(t, e) {
                                    ...
                                    var r, o = t.parentNode,
                                        i = !o;
                                    return i && (o = I).appendChild(t), r = ~N.qsa(o, e).indexOf(t), i && I.removeChild(t), r
                                }, i = function(t) {
                                    ...
                                    var i, u, c;
                                    return m.test(t) && (i = r(l.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(y, "<$1></$2>")), n === e && (n = h.test(t) && RegExp.$1), n in C || (n = "*"), (c = C[n]).innerHTML = "" + t, i = r.each(f.call(c.childNodes), function() {
                                        c.removeChild(this)
                                    ...
                                    if ("string" == typeof t)
                                        ...
                                        if (N.isZ(t)) return t;
                                        if (q(t)) i = t, o = s.call(i, function(t) {
                                            return null != t
                                        });
                                    ...
                                    for (; e && (e = e.parentNode);)
                                        if (e === t) return !0;
                                    return !1
                                }, r.type = P, r.isFunction = R, r.isWindow = j, r.isArray = q, r.isPlainObject = M, r.isEmptyObject = function(t) {
                                    var e;
                                    for (e in t) return !1;
                                    return !0
                                    ...
                                    attr: function(t, r) {
                                        ...
                                        return "string" != typeof t || 1 in arguments ? this.each(function(e) {
                                            if (1 === this.nodeType)
                                                ...
                                                else G(this, t, J(this, r, e, this.getAttribute(t)))
                                    ...
                                    css: function(t, e) {
                                        ...
                                        var a = "";
                                        if ("string" == P(t)) e || 0 === e ? a = U(t) + ":" + H(t, e) : this.each(function() {
                                    ...
                                    addClass: function(t) {
                                        return t ? this.each(function(e) {
                                            if ("className" in this) {
                                                ...
                                                }, this), o.length && K(this, n + (n ? " " : "") + o.join(" "))
                                            }
                                        }) : this
                                    },
                                    removeClass: function(t) {
                                        return this.each(function(n) {
                                            if ("className" in this) {
                                                ...
                                                o = K(this), J(this, t, n, o).split(/\s+/g).forEach(function(t) {
                                                    o = o.replace(F(t), " ")
                                                }), K(this, o.trim())
                                            }
                                        })
                                    ...
                                    r.fn[t] = function() {
                                        ...
                                        return u.length < 1 ? this : this.each(function(t, e) {
                                            ...
                                            u.forEach(function(t) {
                                                ...
                                                Q(d) && "SCRIPT" === t.tagName && t.setAttribute("nonce", d), Q(v) && "STYLE" === t.tagName && t.setAttribute("nonce", v), i.insertBefore(t, e), a && function t(e, n) {
                                                    n(e);
                                                    ...
                                                    null == t.nodeName || "SCRIPT" !== t.nodeName.toUpperCase() || t.type && !s.test(t.type.toLowerCase()) || t.src || function(t, e, n) {
                                                        ...
                                                        if (r) {
                                                            ...
                                                            if (o) {
                                                                ...
                                                                i.innerHTML = e, Q(n) && i.setAttribute("nonce", n), o.appendChild(i), o.removeChild(i)
                                                            }
                                                        }
                                ...
                                }), N.Z.prototype = B.prototype = r.fn, N.uniq = u, N.deserializeValue = X, r.zepto = N, r
                            }();
                            return function(e) {
                                    var n, r = 1,
                    ...
                    function No(t, e, n) {
                        ...
                        return (r = [t, i], p(r) ? bo.race(r) : Oo(new TypeError(Co))).then(function(t) {
                            return d(o), t
                        }, function(t) {
                            throw d(o), t
                        })
                    ...
                    function Lo() {
                        ...
                        return Q(e) ? (Do(e, t), no(Ln)) : (z(no(Ln)) && Do(jo, t), no(Ln))
                    }
                    ...
                    function Yo(t, e) {
                        ...
                        return v(n) || (a.mbox = n), v(r) || (a.error = r), v(o) || (a.url = o), H(i) || (a.analyticsDetails = i), H(u) || (a.responseTokens = u), H(c) || (a.execution = c), a
                    }
                    ...
                    function di(t) {
                        ...
                        if (-1 === e.indexOf(ci)) return xo(e);
                        var n = function(t) {
                            for (var e, n, r, o, i = [], u = B(t), c = u.indexOf(ci); - 1 !== c;) e = B(u.substring(0, c)), o = (n = B(u.substring(c))).indexOf(ai), r = B(n.substring(si, o)), c = (u = B(n.substring(o + 1))).indexOf(ci), e && r && i.push({
                                sel: e,
                                eq: Number(r)
                            });
                            return u && i.push({
                        ...
                        return st(function(t, e) {
                            var n = e.sel,
                                r = e.eq;
                            return t = t.find(n), et(r) && (t = t.eq(r)), t
                        }, xo(u), n)
                    }
                    ...
                    function su() {
                        ...
                        return function(t, e, n) {
                            if (z(e)) return null;
                            if (v(t[ru])) return null;
                            if (!w(t[ru][ou])) return null;
                            var r = t[ru][ou](e, {
                                sdidParamExpiry: n
                            });
                    ...
                    function fu() {
                        return function(t) {
                            ...
                            return b(e) ? st(function(t, e, n) {
                                var r = {};
                                return r[Xn] = n, tu(e) && (r[ie] = e[ie]), eu(e) && (r[Kn] = function(t) {
                                    switch (e[Gn]) {
                                        case 0:
                                            return "unknown";
                                        case 1:
                    ...
                    function xu(t) {
                        ...
                        return No(function(t) {
                            ...
                            return po(hu, Ge, r), go(r), t
                        }).catch(function(t) {
                            var r = bu(Ye, e, mn, n, Be, t);
                            return po(hu, Be, r), go(r), {}
                        })
                    }
                    ...
                    function Tu(t, e, n, r) {
                        q(function(t, o) {
                            b(t) ? (e.push(o), Tu(t, e, n, r), e.pop()) : H(e) ? n[r(o)] = t : n[r(nt(".", e.concat(o)))] = t
                        }, t)
                    }
                    ...
                    function Ou(t) {
                        ...
                        }, [], N(Q, i)), st(function(t, e) {
                            return t[Zr(B(e[0]))] = Zr(B(e[1])), t
                        }, {}, N(ku, e))) : j(i) && Q(i) ? N(function(t, e) {
                            return Q(e)
                        }, Br(i)) : b(i) ? (n = i, o = {}, v(r) ? Tu(n, [], o, E) : Tu(n, [], o, r), o) : {}
                    }
                        ...
                        var t = function() {
                                ...
                                return function(t, e, n) {
                                    return v(t) ? To({}) : No(function(t, e) {
                                        if (!w(t.getVisitorValues)) return To({});
                                        var n = [Gi, Zi, Ji];
                                        return e && n.push(Ki), ko(function(e) {
                    ...
                    function Wu(t) {
                        var e = t.id,
                            ...
                            o = {};
                        return Q(e) && (o.id = e), Q(n) && (o.integrationCode = n), Q(r) && (o.authenticatedState = r), o
                    }
                    ...
                    function tc(t, e) {
                        var n = t.index,
                            ...
                            o = t.address,
                            i = Qu(t, f({}, e, Nu(r)));
                        return v(n) || (i.index = n), Q(r) && (i.name = r), H(o) || (i.address = o), i
                    }

                    function ec(t, e) {
                        if (qo() && !Ao(i, hr)) return null;
                        var n = Nr(),
                            r = function(t) {
                                return function(t, e) {
                            ...
                            h = {};
                        return v(f) ? h.logging = n[yr] : h.logging = f, v(l) || (h.supplementalDataId = l), Q(r) && (h.supplementalDataId = r), v(d) || (h.trackingServer = d), Q(o) && (h.trackingServer = o), v(p) || (h.trackingServerSecure = p), Q(u) && (h.trackingServerSecure = u), H(h) ? null : h
                    }
                    ...
                    function nc(t, e, n) {
                        var r = function(t) {
                            ...
                            s = function(t, e, n, r, o) {
                                var i = {};
                                Q(e) && (i.tntId = e), Q(n) && (i.thirdPartyId = n), Q(t.thirdPartyId) && (i.thirdPartyId = t.thirdPartyId);
                                var u = r[Gi];
                                return Q(u) && (i.marketingCloudVisitorId = u), Q(t.marketingCloudVisitorId) && (i.marketingCloudVisitorId = t.marketingCloudVisitorId), H(t.customerIds) ? (H(o) || (i.customerIds = ot(Wu, o)), i) : (i.customerIds = t.customerIds, i)
                            }(t.id || {}, o, c, e, a),
                            l = function(t, e) {
                                if (!v(t) && Q(t.token)) return t;
                                var n = {},
                                    r = e[ju];
                            ...
                            h = function(t) {
                                if (!v(t) && Q(t.authorizationToken)) return t;
                                var e = {},
                                    n = function() {
                                        var t, e = z(t = Br(i.location.search)[Su]) ? null : t,
                                            n = function() {
                                                var t = Kr(Cu);
                                                return z(t) ? null : t
                                            }();
                                ...
                                return Q(n) && (e.authorizationToken = n), e
                            }(t.trace),
                            m = function(t) {
                                return v(t) ? function() {
                                    var t = Kr(Ei);
                                ...
                                return v(u) || !p(u) || H(u) || (o.views = ot(function(t) {
                                    return function(t, e) {
                                        var n = t.name,
                                            r = t.address,
                                            o = Qu(t, e);
                                        return Q(n) && (o.name = n), H(r) || (o.address = r), o
                                    }(t, e)
                                }, u)), o
                            }(t, r),
                            b = t.notifications,
                            x = {};
                        return x.requestId = dt(), x.context = function(t) {
                            if (!v(t) && t.channel === Zu) return t;
                            var e, n, r = (t || {}).beacon;
                            return {
                        ...
                        }(t.context), H(s) || (x.id = s), H(l) || (x.property = l), H(h) || (x.trace = h), H(d) || (x.experienceCloud = d), H(m) || (x.qaMode = m), H(g) || (x.execute = g), H(y) || (x.prefetch = y), H(b) || (x.notifications = b), x
                    }
                        ...
                        return po(nn, t), go({
                            ...
                            function(t) {
                                ...
                                return ko(function(t, u) {
                                    ...
                                    }(c, t, u), u)).open(Hu, e, i), c.withCredentials = !0, c = function(t) {
                    ...
                    function Rc(t) {
                        var e = t.response;
                        return qc(e) && Uo(e.id.tntId), Uo(null), t
                    }
                    ...
                    function Dc(t) {
                        var e = t.response,
                            ...
                            d = i.views,
                            v = void 0 === d ? [] : d;
                        return jc(c), q(jc, s), q(jc, l), q(jc, v), t
                    }
                    ...
                    function Mc(t) {
                        ...
                        return e[Lc] = n.replace(/\|TS=\d+/, "|TS=" + r), e
                    }
                    ...
                    function ta(t, e) {
                        var n = function(t) {
                                var e = t[Jc] || zc,
                                    ...
                                    c = !!v(t[Qc]) || !0 === t[Qc],
                                    a = {};
                                return a[Jc] = e, a[Gc] = n, a[Kc] = r, a[Xc] = o, a[Yc] = i, a[Wc] = u, a[Qc] = c, a
                            }(e),
                            r = n[Jc],
                            o = n[Gc],
                            i = n[Kc],
                    ...
                    function na(t) {
                        ...
                        if (z(e)) return null;
                        var n = {};
                        return n.type = ee, n.content = e, n
                    }
                    var ra = /CLKTRK#(\S+)/,
                        oa = /CLKTRK#(\S+)\s/;
                    var ia = function(t) {
                    ...
                    function ca(t) {
                        ...
                        switch (e) {
                            ...
                            case Ut:
                                return function(t) {
                                    ...
                                    var e = function(t) {
                                        ...
                                        if (z(n) || z(e)) return t;
                                        var r = t[Et];
                                        return t[Et] = r.replace(oa, ""), t[pt] = function(t, e) {
                                    ...
                                    return j(e[pt]) ? e : (po(Ne, e), null)
                                }(t);
                            case jt:
                                return function(t) {
                                    return ua(t) ? j(t[pt]) ? t : (po(Ne, t), null) : null
                                }(t);
                            case _t:
                                return function(t) {
                                    return ua(t) ? b(t[pt]) ? t : (po(Ie, t), null) : null
                                }(t);
                            case Nt:
                                return function(t) {
                                    return ua(t) ? j(t[pt]) ? t : (po(De, t), null) : null
                                }(t);
                            case It:
                                return function(t) {
                                    return ua(t) ? b(t[pt]) ? t : (po(Ae, t), null) : null
                                }(t);
                            case qt:
                                return function(t) {
                                    return ua(t) ? b(t[pt]) ? t : (po(qe, t), null) : null
                                }(t);
                            case Pt:
                                return function(t) {
                                    return ua(t) ? b(t[pt]) ? t : (po(Pe, t), null) : null
                                }(t);
                            case Rt:
                                return function(t) {
                                    return ua(t) ? t : null
                            ...
                            case At:
                                return function(t) {
                                    return ua(t) ? b(t[pt]) ? t : (po(Re, t), null) : null
                                }(t);
                            case Dt:
                                return function(t) {
                                    var e = t.content;
                                    return z(e) ? (po(je, t), null) : (t.content = Fc(e, {}), t)
                                }(t);
                            default:
                                return null
                        }
                        ...
                        switch (t.type) {
                            case Dt:
                                return To(function(t) {
                                    var e = t.content;
                                    if (z(e)) return po(je, t), null;
                                    var n = f({}, t);
                                    return n.content = Fc(e, {}), n
                                }(t));
                            case ne:
                                return function(t) {
                                    return ea(function(t, e, n) {
                                        var r = {};
                                        return r[Jc] = zc, r[Gc] = function(t, e) {
                                            return Uc(t, e, Vc)
                                        }(t, e), r[Wc] = n, r
                    ...
                    function ga(t) {
                        var e = t[0],
                            ...
                            u = {},
                            c = {};
                        b(e) && (c.pageLoad = e), H(n) || (c.mboxes = n);
                        var a = {};
                    ...
                    function ya(t) {
                        var e = A([Dc, Pc, Rc])(t),
                            n = function(t) {
                                ...
                                if (!b(e)) return To(null);
                                var n = e.pageLoad;
                                if (!b(n)) return To(null);
                                var r = n.analytics,
                                    o = n.options,
                                    i = n.metrics,
                                    u = {
                            ...
                            o = function(t) {
                                ...
                                return !p(r) || H(r) ? To([]) : _o(ot(function(t) {
                                    return function(t, e) {
                                        ...
                                        return v(a) || la(s, a), _o([pa(u, Nc), ha(c, Ic)]).then(function(t) {
                                            return da(s, t)
                                        })
                                    }(e, t)
                                }, N(wc, r))).then(hc)
                            ...
                            i = function(t) {
                                ...
                                return !p(r) || H(r) ? To([]) : _o(ot(function(t) {
                                    return function(t, e) {
                                        ...
                                        return v(c) || la(a, c), _o([pa(i, Nc), ha(u, Ac)]).then(function(t) {
                                            return da(a, t)
                                        })
                                    }(e, t)
                                }, N(Ec, r))).then(hc)
                    ...
                    function wa(t) {
                        ...
                        return Wo({
                            ...
                            return function(t, e) {
                                var n = xa(e);
                                return n.mbox = t, po(Te, e), Qo(n, ba(e)), To(e)
                            }(n, t)
                        }).catch(function(t) {
                            return function(t, e) {
                                return vo(ke, e), ti({
                    ...
                    function Ea(t) {
                        ...
                        return Wo({}), oc(o, {}).then(function(t) {
                            return cc(t, i)
                        }).then(ya).then(function(t) {
                            return function(t) {
                                var e = xa(t),
                                ...
                                return H(n) || (e.analyticsDetails = n), po(Te, t), Qo(e, ba(t)), To(t)
                            }(t)
                        }).catch(function(t) {
                            return function(t) {
                                return vo(ke, t), ti({
                    ...
                    function Ma(t) {
                        return po(Me, t), ka(oe, Ta(oe, t, xo("<" + fe + "/>")))
                    }

                    function Va(t) {
                        var e = N(ja, U(mi(fe, t)));
                        return H(e) ? t : (q(Ma, ot(Ra, e)), t)
                    }
                    ...
                    function Ga(t, e) {
                        return n = Mi(e), di(t).prepend(n);
                        var n
                    }

                    function Ka(t, e) {
                        var n = hi(t);
                        return Ri(Di(Mi(e), t)), n
                    }
                    ...
                    function Qa(t) {
                        var e = function(t) {
                            ...
                            if (z(n)) return e;
                            var r, o = di(e[Et]);
                            return r = ae, di(o).is(r) ? (e[vt] = Ft, e[pt] = function(t) {
                                var e = pi(n);
                                return nt("", st(function(t, e) {
                                    return t.push(Mi(pi(e))), t
                                }, [], U(mi(Ba, e))))
                            }(), e) : e
                        }(t);
                        switch (e[vt]) {
                            ...
                            case Ft:
                                return function(t) {
                                    return po(_e, t), $a(Ja, t)
                                }(e);
                            case $t:
                                return function(t) {
                                    return po(_e, t), $a(Ga, t)
                                }(e);
                            case zt:
                                return function(t) {
                                    return po(_e, t), $a(Ka, t)
                                }(e);
                            case Vt:
                                return function(t) {
                                    return po(_e, t), $a(Xa, t)
                                }(e);
                            case Ut:
                                return function(t) {
                                    return po(_e, t), $a(Ya, t)
                                }(e);
                            case jt:
                                return function(t) {
                                    return po(_e, t), $a(Wa, t)
                                }(e);
                            case _t:
                                return function(t) {
                                    var e = t[pt],
                            ...
                            case qt:
                                return function(t) {
                                    var e = di(t[Et]),
                                        n = t[pt];
                                    return n[mt] = za(n[mt]), n[ht] = za(n[ht]), po(_e, t), go({
                                        action: t
                                    }), Ca(n, e), To(t)
                                }(e);
                            case Pt:
                                return function(t) {
                                    var e = di(t[Et]),
                                        n = t[pt];
                                    return n[gt] = za(n[gt]), n[yt] = za(n[yt]), po(_e, t), go({
                                        action: t
                                    }), Ca(n, e), To(t)
                                }(e);
                            case Rt:
                            ...
                            case At:
                                return function(t) {
                                    var e = di(t[Et]),
                                        ...
                                        u = i[r],
                                        c = i[o];
                                    return vi(u) && vi(c) ? (po(_e, t), go({
                                        action: t
                                    }), r < o ? ji(u, c) : Di(u, c), To(t)) : (po(Le, t), Oo(t))
                                }(e);
                            default:
                                return To(e)
                        }
                    ...
                    function Ts(t, e, n) {
                        var r = function(t, e) {
                            return rc(t, e, function() {
                                return [(t = su(), e = Nr()[Tn], v(t) ? {} : function(t, e) {
                    ...
                    function _s(t) {
                        ...
                        return function(t, e) {
                            return fs in (n = i) && ls in n[fs] ? function(t, e, n) {
                                ...
                                r[nr] = [rr];
                                var o = {};
                                o[Jc] = Zc, o[Gc] = e, o[Xc] = n, o[Yc] = !0, o[Qc] = !1, o[Kc] = r;
                                try {
                                    t(o)
                                } catch (t) {
                                    return !1
                            ...
                            var n
                        }(e, JSON.stringify(t)) ? (po(ps, e, t), !0) : (vo(hs, e, t), !1)
                    }
                    ...
                    function of(t, e, n) {
                        var r = y({
                            ...
                            o = ot(Cc, N(dc, n)),
                            i = {};
                        return H(o) || (r.status = Be, i.errors = o), H(i) || (r.data = i), r
                    }
                        ...
                        return _o(rf(function(t) {
                            ...
                            return function(t, e, n) {
                                var r = y({
                                    ...
                                    i = ot(Cc, N(Xs, n)),
                                    u = {};
                                return H(o) || (r.status = Be, u.errors = o), H(i) || (u.eventTokens = i), H(u) || (r.data = u), r
                            }(t, e, n)
                        }).then(function(t) {
                            return r(e), t
                        })
                                ...
                                switch (t.action) {
                                    case kt:
                                        Q((e = t).selector) && Q(e.cssSelector) ? o.push(function(t) {
                                            var e = {};
                                            return e.type = Ct, e.content = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                        }(t)) : n.push({
                                            type: ee,
                                            content: t.content
                                        });
                                    ...
                                    case Tt:
                                        o.push(function(t) {
                                            var e = {};
                                            return e.type = Tt, e.content = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                        }(t));
                                        break;
                                    case Ht:
                                        o.push(function(t) {
                                    ...
                                    case _t:
                                        o.push(function(t) {
                                            var e = {};
                                            if (e.selector = t.selector, e.cssSelector = t.cssSelector, t.attribute === oe) return e.type = Nt, e.content = t.value, e;
                                            e.type = _t;
                                            var n = {};
                                    ...
                                    case It:
                                        o.push(function(t) {
                                            var e = t.style,
                                                n = void 0 === e ? {} : e,
                                                r = {};
                                            return r.selector = t.selector, r.cssSelector = t.cssSelector, v(n.left) || v(n.top) ? v(n.width) || v(n.height) ? (r.type = It, r.content = n, r) : (r.type = qt, r.content = n, r) : (r.type = Pt, r.content = n, r)
                                        }(t));
                                        break;
                                    case Rt:
                                        o.push(function(t) {
                                            var e = {};
                                            return e.type = Rt, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                        }(t));
                                        break;
                                    case At:
                                        o.push(function(t) {
                                            ...
                                            var n = {};
                                            return n.type = At, n.selector = t.selector, n.cssSelector = t.cssSelector, n.content = e, n
                                        }(t));
                                        break;
                                    case Dt:
                                        n.push(gf(t));
                    ...
                    function _f(t) {
                        if (v(t)) return [null];
                        var e = ot(Cf, [t]);
                        return Sf(e) && vo(bf, t), e
                    }

                    function Nf(t) {
                        if (v(t)) return [null];
                        var e = ot(kf, t);
                        return Sf(e) && vo(xf, t), e
                    }
                    ...
                    function Af(t) {
                        ...
                        if (v(t)) return [null];
                        var n = ot(Tf, [t]);
                        return Sf(n) && vo(wf, t), t.view.page ? (e(t), n) : n
                    }

                    function qf(t) {
                        if (v(t)) return [null];
                        var e = ot(Of, [t]);
                        return Sf(e) && vo(Ef, t), e
                    }
                    ...
                    function Mf(t) {
                        ...
                        }(i)), H(c) ? e.push(To(null)) : e.push(_o(ot(af, c)));
                        var a = t.prefetch,
                            s = void 0 === a ? {} : a,
                            f = s.mboxes,
                            l = void 0 === f ? [] : f,
                            d = s.metrics,
                            v = void 0 === d ? [] : d;
                        return H(l) ? e.push(To(null)) : e.push(_o(ot(sf, l))), p(v) && !H(v) ? e.push(_o([zs(s)]).then(of)) : e.push(To(null)), Bi(), _o(e).then(Pf).catch(Rf)
                    }
                    ...
                    function Hf(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            n = t.selector,
                            r = t.response;
                        if (H(r)) return po(Fe), Ff(n), Bi(), oi({}), hf(wr), To();
                        var o = Lf(n, r),
                            u = sa(o);
                        if (!H(u)) {
                            var c = u.url;
                        ...
                        return ei({}),
                            function(t) {
                                var e = t.prefetch,
                                    ...
                                    r = void 0 === n ? [] : n;
                                H(r) || q(ds, r)
                            }(o), hf(xr), ff(o, e), Mf(o).then(function(t) {
                                H(t) || ni({
                                    execution: t
                                })
                            }).catch(function(t) {
                    ...
                    function Zf() {
                        ...
                        if (function(t) {
                            ...
                            ff(c), H(u = void 0 === (i = (void 0 === (o = c.prefetch) ? {} : o).views) ? [] : i) || Ws(I(ot(Qs, u))), ya({
                                request: n,
                                response: c
                            }).then(function(t) {
                                return zf(t, !0)
                                        ...
                                        return q(function(t) {
                                            switch (t.type) {
                                                case Ct:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = kt, e.content = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case Tt:
                                                    e.push(function(t) {
                                                ...
                                                case zt:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = Zt, e.content = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case Vt:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = Vt, e.content = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case Ut:
                                                    e.push(function(t) {
                                                ...
                                                case _t:
                                                    e.push(function(t) {
                                                        var e = C(t.content)[0],
                                                            n = {};
                                                        return n.action = _t, n.attribute = e, n.value = t.content[e], n.selector = t.selector, n.cssSelector = t.cssSelector, n
                                                    }(t));
                                                    break;
                                                case Nt:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = _t, e.attribute = oe, e.value = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case It:
                                                case qt:
                                                case Pt:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = It, e.style = t.content, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case Rt:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = Rt, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case At:
                                                    e.push(function(t) {
                                                        var e = {};
                                                        return e.action = At, e.from = t.content.from, e.to = t.content.to, e.selector = t.selector, e.cssSelector = t.cssSelector, e
                                                    }(t));
                                                    break;
                                                case Dt:
                                                    e.push(Xf(t))
                    ...
                    function Qf(t) {
                        var e = function(t) {
                            ...
                            n = e[Be];
                        if (!e[Je]) return vo(Wf, n), void go({
                            source: Wf,
                            options: t,
                            error: n
                        });
                        if (!co()) return l(t[Be](ze, de)), vo(Wf, de), void go({
                            source: Wf,
                            options: t,
                            error: de
                        });
                                ...
                                return function(t, e) {
                                    var n = function(t) {
                                        var e = t.execute,
                                            ...
                                            u = void 0 === i ? [] : i,
                                            c = [];
                                        return c.push.apply(c, Yf(o)), c.push.apply(c, I(ot(Yf, u))), c
                                    }(e);
                                    t[Ge](n)
                                }(t, e)
                            },
                    ...
                    function rl(t) {
                        var e = Uf(t.selector),
                            ...
                            r = n[Be];
                        return n[Je] ? co() ? (t.selector = e, po(nl, t), go({
                                source: nl,
                                options: t
                            }), void
                            function(t) {
                                var e = t.mbox,
                                    ...
                                    o = Nr(),
                                    u = e === o[pn];
                                if (H(r)) return po(Fe), Ff(n), Bi(), void oi({
                                    mbox: e
                                });
                                var c = Lf(n, yf(e, r, u)),
                                    a = sa(c);
                    ...
                    function il(t) {
                        var e = Uf(t.selector),
                            ...
                            r = n[Be];
                        return n[Je] ? co() ? (t.selector = e, po(ol, t), go({
                            source: ol,
                            options: t
                        }), Hf(t)) : (vo(ol, de), go({
                            source: ol,
                            options: t,
                            error: de
                        }), Ff(e), Oo(new Error(de))) : (vo(ol, t, r), go({
                            source: ol,
                            options: t,
                            error: r
                        }), Ff(e), Oo(n))
                    ...
                    function cl(t) {
                        var e = Nr()[pn],
                            ...
                            u = i[Be];
                        if (!i[Je]) return vo(ul, u), void go({
                            source: ul,
                            options: t,
                            error: u
                        });
                        if (!co()) return vo(ul, de), void go({
                            source: ul,
                            options: t,
                            error: de
                        });
                    ...
                    function sl(t) {
                        if (qo() && !Po()) return vo(Ue, gr), void t[Be](Be, gr);
                        ! function(t) {
                            var e = t.mbox,
                            ...
                            if (i.mbox = {
                                    name: e
                                }, _s(Ts(e, r, [i]))) return po(Ve, t), void t[Ge]();
                            vo(Ue, t), t[Be](Ze, Ue)
                        }(t)
                    }
                    ...
                    function fl(t) {
                        var e = function(t) {
                            ...
                            n = e[Be];
                        if (!e[Je]) return vo(al, n), void go({
                            source: al,
                            options: t,
                            error: n
                        });
                        var r = function(t, e) {
                            ...
                            return r[Qe] = f({}, Nu(n), o), r[vn] = ic(t, e[vn]), r[Ge] = w(e[Ge]) ? e[Ge] : it, r[Be] = w(e[Be]) ? e[Be] : it, r
                        }(Nr(), t);
                        if (!co()) return vo(al, de), l(r[Be](ze, de)), void go({
                            source: al,
                            options: t,
                            error: de
                        });
                    ...
                    function yl(t) {
                        ...
                        }(t), v(vs(t.viewName, t)) && t.page && function(t) {
                            var e = t.viewName,
                                n = t.impressionId,
                                r = Nu(Nr()[pn]),
                                o = Os(Qu({}, r), er, []);
                        ...
                        }(t), dl.push(t), pl === vl && ml()
                    }

                    function bl(t, e) {
                        if (!j(t) || z(t)) return vo(ll, ur, t), void go({
                            source: ll,
                            view: t,
                            error: ur
                        });
                        var n = t.toLowerCase(),
                            r = function(t, e) {
                                var n = {};
                                return n.viewName = t, n.impressionId = dt(), n.page = !0, H(e) || (n.page = !!e.page), n
                            }(n, e);
                        po(ll, n, r), go({
                            source: ll,
                            view: n,
                    ...
                    return {
                        init: function(t, e, n) {
                            if (t.adobe && t.adobe.target && void 0 !== t.adobe.target.getOffer) vo("Adobe Target has already been initialized.");
                            else {
                                ! function(t) {
                                    _r(i, u, t);
                                    var e = i.location.protocol === Sr;
                                    (Tr = f({}, t))[xn] = t[xn] / 1e3, Tr[wn] = t[wn] / 1e3, Tr[In] = Tr[On] || e ? "https:" : ""
                                }(n);
                                var r, o = Nr(),
                                    c = o[mn];
                                ...
                                (function(t, e, n) {
                                    ...
                                    if (t[Fn] = r, n) {
                                        var o = r.push;
                                        r[mn] = ho, r[Mn] = function(t) {
                                            return st(function(e, n) {
                                                return e[n] = t[n], e
                                            }, {}, Or)
                                        }(e), r[Vn] = [], r[Un] = [], r.push = function(t) {
                                            r[Un].push(f({
                                                timestamp: ut()
                                            }, t)), o.call(this, t)
                                        }
                                ...
                                function() {
                                    if (so()) {
                                        i[bi] = i[bi] || {}, i[bi].querySelectorAll = di;
                                        var t = Nr()[Nn];
                                        po(yi), ui(t).then(function() {
                                ...
                                function(t) {
                                    var e = function(t) {
                                        ...
                                        var c, a = e[Ci];
                                        return H(a) ? r : (r.previewIndexes = p(c = a) ? Pi(c) : Pi([c]), r)
                                    }(t.location.search);
                                    if (!v(e)) {
                                ...
                                }(t), Zf(), t.adobe.target.getOffer = Qf, t.adobe.target.getOffers = el, t.adobe.target.applyOffer = rl, t.adobe.target.applyOffers = il, t.adobe.target.sendNotifications = cl, t.adobe.target.trackEvent = fl, t.adobe.target.triggerView = bl, t.adobe.target.registerExtension = kl, t.mboxCreate = Tl, t.mboxDefine = Ol, t.mboxUpdate = _l, r = Yo(Ho, {}), Fo(i, u, Ho, r)
                            }
                        }
                    }
                }
    ...
    "@marcom/ac-target": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.initialize = initialize, exports.getInstanceSettings = getInstanceSettings;
        var instanceSettings, _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty")),
            _acConsole = require("@marcom/ac-console"),
            _initializeTarget = require("./initializeTarget"),
            _settings = require("./settings"),
            _addEventListeners = _interopRequireDefault(require("./addEventListeners")),
            _util = require("./util");
        ...
        function _objectSpread(t) {
            for (var e = 1; e < arguments.length; e++) {
                ...
                e % 2 ? ownKeys(Object(n), !0).forEach(function(e) {
                    (0, _defineProperty2.default)(t, e, n[e])
        ...
        function setup() {
            ...
            (0, _acConsole.log)("ac-target : setup : custom settings", t), t && t.options && !1 === t.options.autoInitialize || initialize(t)
        }

        function initialize(t) {
            instanceSettings = getSettings(t), (0, _acConsole.log)("initialize: instance settings", instanceSettings), (0, _addEventListeners.default)(), (0, _initializeTarget.initializeTarget)(instanceSettings.config)
        }
        ...
        function getCustomSettings() {
            if (window.acTargetCustomSettings) return (0, _util.isNode)(window.acTargetCustomSettings) ? getSettingsFromDOM() : window.acTargetCustomSettings
        }

        function getSettings(t) {
            var e = _objectSpread({}, _settings.defaultSettings);
            return setRuntimeSettings(e), mergeCustomSettings(e, t)
        }

        function setRuntimeSettings(t) {
            t.config.serverDomain = getServerDomain(), window.location.origin && (t.constants.origin = window.location.origin)
        }

        function getServerDomain() {
            var t = "securemvt.apple.com";
            return "www.apple.com.cn" === window.location.hostname && (t = "securemvt.apple.com.cn"), t
        }

        function mergeCustomSettings(t, e) {
            return e || (e = getCustomSettings()), (0, _acConsole.log)("ac-target : mergeCustomSettings : customSettings and targetGlobalSettings", e, window.targetGlobalSettings), e && Object.keys(t).forEach(function(n) {
                e[n] && (t[n] = _objectSpread(_objectSpread({}, t[n]), e[n]))
            }), window.targetGlobalSettings = window.targetGlobalSettings || {}, window.targetGlobalSettings.dataProviders ? window.targetGlobalSettings.dataProviders.push(_settings.astexDataProvider) : window.targetGlobalSettings.dataProviders = [_settings.astexDataProvider], t
        }
        ...
        function getSettingsFromDOM() {
            ...
            if (t) try {
                ...
                (0, _acConsole.log)("ac-target : error parsing acTargetCustomSettings : ".concat(t))
            }
        }
        setup()
    }, {
